...
<html lang="pt-br">
                ...
                <nav class="site-navigation text-right" role="navigation">
                  <div class="container">
                    ...
                    <ul class="site-menu js-clone-nav d-none d-lg-block">
					   ...
					   <li><a href="#"><span class="bg-primary text-white py-3 px-4 rounded">Sair</span></a></li>
                    </ul>
                  </div>
                </nav>
              </div>
 ...
 <div class="row">
           <div class="col-md-10 mx-auto text-center mb-5 section-heading">
             ...
             <br>
             <br>
              <form action="ValidaCategoria.php" method="POST" enctype="multipart/form-data">
               <label for="nomeCategoria">Nome: </br></label>
